...
import { EquipmentSelectionDialog } from "../../../_components/equipment-selection-dialog";
import { MuscleSelectionDialog } from "../../../_components/muscle-selection-dialog";
import { SkillSelectionDialog } from "../../../_components/skill-selection-dialog";
...
export default function EditPrivateSkillPage() {
  ...
  const form = useAppForm({
    defaultValues: {
      ...
      muscles: (skill?.muscles as string[]) ?? [],
      equipment: (skill?.equipment as string[]) ?? [],
      prerequisites: (skill?.prerequisites as string[]) ?? [],
      variants: (skill?.variants as string[]) ?? [],
      embedded_videos:
        skill?.embedded_videos && skill.embedded_videos.length > 0
          ? skill.embedded_videos
          : [""],
