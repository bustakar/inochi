...
function SidebarTrigger(_a) {
  ...
  return (
    <button_1.Button
      ...
      variant="ghost"
      size="icon"
      className={(0, utils_1.cn)("size-7", className)}
...
function SidebarSeparator(_a) {
  ...
  return (
    <separator_1.Separator
      ...
      className={(0, utils_1.cn)("bg-sidebar-border mx-2 w-auto", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSubItem(_a) {
  ...
  return (
    <li
      ...
      className={(0, utils_1.cn)("group/menu-sub-item relative", className)}
      {...props}
    />
  );
}
