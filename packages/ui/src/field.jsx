...
var fieldVariants = (0, class_variance_authority_1.cva)(
...
function FieldError(_a) {
  var className = _a.className,
    ...
    errors = _a.errors,
    props = __rest(_a, ["className", "children", "errors"]);
  var content = (0, react_1.useMemo)(
    function () {
      var _a;
      if (children) {
        return children;
      ...
      var uniqueErrors = __spreadArray(
        [],
        new Map(
      ...
      if (
        (uniqueErrors === null || uniqueErrors === void 0
          ? void 0
          : uniqueErrors.length) == 1
      ) {
        return (_a = uniqueErrors[0]) === null || _a === void 0
          ? void 0
          : _a.message;
      }
      return (
